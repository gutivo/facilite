...
from .views import AtividadeLeitura,DashList
...
urlpatterns = [ 
   ...
   path('alterar/atividade/<int:pk>/',AtividadeLeitura.as_view(), name ="alterar-atividade"),
   ...
   path('dash/',DashList.as_view(), name ='dash'),
